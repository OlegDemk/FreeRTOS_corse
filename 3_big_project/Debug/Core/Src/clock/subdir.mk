...
C_SRCS += \
../Core/Src/clock/DS3231.c \
../Core/Src/clock/i2c_scanner.c 

OBJS += \
./Core/Src/clock/DS3231.o \
./Core/Src/clock/i2c_scanner.o 

C_DEPS += \
./Core/Src/clock/DS3231.d \
./Core/Src/clock/i2c_scanner.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/clock/%.o: ../Core/Src/clock/%.c Core/Src/clock/subdir.mk
...
clean-Core-2f-Src-2f-clock:
	-$(RM) ./Core/Src/clock/DS3231.d ./Core/Src/clock/DS3231.o ./Core/Src/clock/i2c_scanner.d ./Core/Src/clock/i2c_scanner.o
